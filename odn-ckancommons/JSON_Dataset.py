...
class JSON_Dataset():
    ...
    def tojson_without_resource(self):
        return { "name" : self.name, "title" :  self.title, "notes": self.notes, "author": self.author, "extras": self.extras , "resources" : [], "license_id" : self.license, "owner_org" : self.owner_org, "notes": self.description}
